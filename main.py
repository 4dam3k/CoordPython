...
class Rectangle:
    ...
    def Draw(self, ax):
        ...
        polygon = plt.Polygon([(v.x, v.y) for v in self.Vertices],
...
p1 = Rectangle(Point(0, 0), size=(4, 4), fill=False, color="orange")
p1.Draw(ax)
p2 = Rectangle(Point(-2, -4), size=(4,4), fill=False, color="purple")
p2.Draw(ax)
